...
function App() {
  ...
  if (modalShow) return <div
    className="w-screen grid place-items-center fixed h-screen top-0 left-0 right-0 bottom-0 bg-gradient-to-r from-violet-500 to-fuchsia-500">
