        ...
        <div
          ...
          <div className="flex flex-col items-center pb-10">
            <LazyLoadImage
                ...
                className="w-full object-cover mb-3 shadow-lg"
                src={Mahina}
                alt="Махина Саидова Равшанджоновна"
            />
            <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Махина Саидова</h5>
            <span className="text-sm text-gray-500 dark:text-gray-400">Самая лучшая биолог</span>
            <div className="flex mt-4 space-x-3 md:mt-6">
              <a href="№"
                 className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Связаться
